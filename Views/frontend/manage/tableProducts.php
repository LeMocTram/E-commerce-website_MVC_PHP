...
<div class="card-body">
    <div class="row">  
        <div class="col-sm-12 col-md-6">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-add-new-product"><i class="fa-solid fa-plus"></i> Add Product</button>
        </div>
        <div class="col-sm-12 col-md-6">
...
<div class="modal fade" id="modal-edit-product" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="post" action='?controller=dashboard&action=update' enctype="multipart/form-data">
            <div class="modal-body">
                <div class="card-body">
